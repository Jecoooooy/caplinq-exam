declare global {
    ...
    // get arguments type
    type FirstArgument<T extends AnyFunction> = T extends (arg: infer A, ...args: any) => any ? A : never;
    ...
    type DeepReadonly<T> = T extends Primitive
        ? T
        : {
              readonly [P in keyof T]: T[P] extends (infer R)[] ? ReadonlyArray<DeepReadonly<R>> : DeepReadonly<T[P]>;
          };
